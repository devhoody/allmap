...
public class RestaurantController {
    ...
    @GetMapping("{restId}/edit")
    public String edit(@PathVariable Long restId, Model model) {
        Restaurant findRestaurant = restaurantService.findById(restId);
        model.addAttribute("rest", findRestaurant);
        return "rest/editRest";
    }

    @PostMapping("{restId}/edit")
    public String edit(@PathVariable Long restId,
        ...
        Restaurant editRestaurant = restaurantService.edit(restaurant);
        log.info(editRestaurant.toString());

        redirectAttributes.addAttribute("restId", editRestaurant.getId());
        return "redirect:/rest/{restId}";
    }
